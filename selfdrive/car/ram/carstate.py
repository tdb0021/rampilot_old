...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    self.autoHighBeamBit = bool(cp_cam.vl["FORWARD_CAMERA_HUD"]['AUTO_HIGH_BEAM_BIT']) # maybe this instead of cruisestate
...
#    ret.cruiseState.autoHighBeamBit = cp_cam.vl["FORWARD_CAMERA_HUD"]['AUTO_HIGH_BEAM_BIT'] # maybe not cruisestate
